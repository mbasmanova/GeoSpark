...
class JoinTestBase {
    ...
    protected JoinTestBase(GridType gridType, boolean useLegacyPartitionAPIs) {
    ...
    protected PointRDD createPointRDD(String location) {
        ...
        return new PointRDD(rdd.rawSpatialRDD.distinct(), StorageLevel.MEMORY_ONLY());
    }
    ...
    protected LineStringRDD createLineStringRDD(String location) {
        ...
        return new LineStringRDD(rdd.rawSpatialRDD.distinct(), StorageLevel.MEMORY_ONLY());
    }
    ...
    protected PolygonRDD createPolygonRDD(String location) {
        ...
        return new PolygonRDD(rdd.rawSpatialRDD.distinct(), StorageLevel.MEMORY_ONLY());
    }
    ...
    protected RectangleRDD createRectangleRDD(String location) {
        ...
        return new RectangleRDD(rdd.rawSpatialRDD.distinct(), StorageLevel.MEMORY_ONLY());
    }
